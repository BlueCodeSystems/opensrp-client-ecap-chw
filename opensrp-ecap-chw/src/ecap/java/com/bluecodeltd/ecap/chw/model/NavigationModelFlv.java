...
public class NavigationModelFlv implements NavigationModel.Flavor {
    ...
    public List<NavigationOption> getNavigationItems() {
        ...
        if (navigationOptions.size() == 0) {
            ...
            NavigationOption reportRegisterNavigationOption = new NavigationOption(org.smartregister.chw.core.R.drawable.sidemenu_service_activity, org.smartregister.chw.core.R.drawable.sidemenu_service_activity, R.string.all_report_register_title, Constants.DrawerMenu.REPORT_REGISTER, 0);
