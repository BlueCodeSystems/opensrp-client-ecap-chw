...
import com.bluecodeltd.ecap.chw.activity.CoreBeneficiariesRegisterActivity;
import com.bluecodeltd.ecap.chw.activity.CoreIndexRegisterActivity;
...
public class ChwApplication extends CoreChwApplication implements SyncStatusBroadcastReceiver.SyncStatusListener, P2pProcessingStatusBroadcastReceiver.StatusUpdate {
    ...
    public Map<String, Class> getRegisteredActivities() {
       ...
       // registeredActivities.put(CoreConstants.REGISTERED_ACTIVITIES.ANC_REGISTER_ACTIVITY, AncRegisterActivity.class);
        ...
        registeredActivities.put(CoreConstants.REGISTERED_ACTIVITIES.INDEX_REGISTER_ACTIVITY, CoreIndexRegisterActivity.class);
        registeredActivities.put(CoreConstants.REGISTERED_ACTIVITIES.BENEFICIARIES_REGISTER_ACTIVITY, CoreBeneficiariesRegisterActivity.class);
