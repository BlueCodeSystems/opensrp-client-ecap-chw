...
public class MemberSocialFundModel {
    ...
    private String social_fund_date;
    private String delete_status;
    private String facilitator_id;

    public MemberSocialFundModel() {
        ...
        this.amount = amount;
        this.social_fund_date = social_fund_date;
    ...
    public String getSocial_fund_date() {
        return social_fund_date;
    }

    public void setSocial_fund_date(String social_fund_date) {
        this.social_fund_date = social_fund_date;
    }
