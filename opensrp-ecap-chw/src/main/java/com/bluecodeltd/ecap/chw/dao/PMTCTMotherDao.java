...
//    }
    ...
    public static DataMap<PtctMotherModel> getPtctMotherModelMap() {
        return c -> {
            ...
            record.setAgyw_sm_number(getCursorValue(c, "agyw_sm_number"));
            ...
            record.setSyphylis_testing(getCursorValue(c, "syphylis_testing"));
            record.setDate_tested_syphylis(getCursorValue(c, "date_tested_syphylis"));
