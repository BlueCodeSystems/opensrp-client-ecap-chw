...
public class MotherIndexFragmentPresenter implements MotherIndexFragmentContract.Presenter{
    ...
    public void initializeQueries(String s) {
        ...
        String mainSelect = "SELECT id as _id, relationalid, relationalid AS relational_id, mother_first_name AS first_name, mother_surname AS last_name, health_facility, health_facility AS residence FROM " + mothers;
