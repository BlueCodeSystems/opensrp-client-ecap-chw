...
public class WeGroupMemberSocialForMemberAdapter extends RecyclerView.Adapter<WeGroupMemberSocialForMemberAdapter.ViewHolder> {
    private final Context context;
    ArrayList<MemberSocialFundModel> dataSet;

    public WeGroupMemberSocialForMemberAdapter(Context context, ArrayList<MemberSocialFundModel> dataSet) {
    ...
    @NonNull
    @Override
    public WeGroupMemberSocialForMemberAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_member_service, parent, false);
        return new WeGroupMemberSocialForMemberAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WeGroupMemberSocialForMemberAdapter.ViewHolder holder, int position) {
