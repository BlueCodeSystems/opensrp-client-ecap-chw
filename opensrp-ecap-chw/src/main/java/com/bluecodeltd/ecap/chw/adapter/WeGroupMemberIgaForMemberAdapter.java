...
public class WeGroupMemberIgaForMemberAdapter extends RecyclerView.Adapter<WeGroupMemberIgaForMemberAdapter.ViewHolder> {

    private final Context context;
    private final List<MemberIGAModel> dataSet;

    public WeGroupMemberIgaForMemberAdapter(Context context, List<MemberIGAModel> dataSet) {
    ...
    @NonNull
    @Override
    public WeGroupMemberIgaForMemberAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_member_service, parent, false);
        return new WeGroupMemberIgaForMemberAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WeGroupMemberIgaForMemberAdapter.ViewHolder holder, int position) {
