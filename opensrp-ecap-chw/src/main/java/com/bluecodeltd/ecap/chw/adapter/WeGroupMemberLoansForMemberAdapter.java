...
public class WeGroupMemberLoansForMemberAdapter extends RecyclerView.Adapter<WeGroupMemberLoansForMemberAdapter.ViewHolder> {
    private final Context context;
    private final List<MemberLoanModel> dataSet;

    public WeGroupMemberLoansForMemberAdapter(Context context, List<MemberLoanModel> dataSet) {
    ...
    @NonNull
    @Override
    public WeGroupMemberLoansForMemberAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_member_service, parent, false);
        return new WeGroupMemberLoansForMemberAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WeGroupMemberLoansForMemberAdapter.ViewHolder holder, int position) {
        MemberLoanModel currentItem = dataSet.get(position);
        ...
        holder.dateTextView.setText(" Loan Deposited K:" + currentItem.getAmount() + " Date Loan Deposited: " + currentItem.getDate_of_loan());
