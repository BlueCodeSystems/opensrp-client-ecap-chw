...
import com.bluecodeltd.ecap.chw.fragment.PncRegisterFragment;
        ...
        if (resultCode == Activity.RESULT_OK) {
            try {
                ...
                if (CoreConstants.EventType.PREGNANCY_OUTCOME.equals(encounter_type)) {
                    ...
                    String pregnancyOutcome = org.smartregister.util.JsonFormUtils.getFieldJSONObject(fields, com.bluecodeltd.ecap.chw.util.Constants.pregnancyOutcome).optString(JsonFormUtils.VALUE);
                    if (EnumUtils.isValidEnum(com.bluecodeltd.ecap.chw.util.Constants.FamilyRegisterOptionsUtil.class, pregnancyOutcome)) {
