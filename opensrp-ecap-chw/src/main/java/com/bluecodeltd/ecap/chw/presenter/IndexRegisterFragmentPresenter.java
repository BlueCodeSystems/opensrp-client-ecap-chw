...
public class IndexRegisterFragmentPresenter implements IndexRegisterFragmentContract.Presenter {
    ...
    public void initializeQueries(String s) {
        ...
        String mainSelect = "SELECT *, ec_client_index.id as _id, ec_client_index.relationalid AS relational_id, ec_client_index.health_facility AS residence, first_name AS adolescent_first_name,last_name As adolescent_last_name, gender as adolescent_gender FROM ec_client_index WHERE case_status IS NOT NULL AND unique_id IS NOT NULL";
