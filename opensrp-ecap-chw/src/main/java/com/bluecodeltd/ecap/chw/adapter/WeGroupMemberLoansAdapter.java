...
public class WeGroupMemberLoansAdapter extends RecyclerView.Adapter<WeGroupMemberLoansAdapter.ViewHolder> {
    private final Context context;
    private final List<MemberLoanModel> dataSet;

    public WeGroupMemberLoansAdapter(Context context, List<MemberLoanModel> dataSet) {
    ...
    @NonNull
    @Override
    public WeGroupMemberLoansAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_member_service, parent, false);
        return new WeGroupMemberLoansAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WeGroupMemberLoansAdapter.ViewHolder holder, int position) {
