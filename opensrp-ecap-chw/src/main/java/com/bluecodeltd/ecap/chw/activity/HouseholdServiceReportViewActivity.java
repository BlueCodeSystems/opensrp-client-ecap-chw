...
public class HouseholdServiceReportViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_household_service_report_view);
    ...
    private void loadReport() {
        ...
        Threading.io(() -> {
            HouseholdServiceReportModel model = null;
            try { model = HouseholdServiceReportDao.getServiceReportByEntityId(baseEntityId); } catch (Exception ignored) {}
            HouseholdServiceReportModel finalModel = model;
            Threading.main(() -> {
                if (finalModel != null) {
    ...
    private void populateData(HouseholdServiceReportModel model) {
        setText(R.id.txt_date, model.getDate());
        setText(R.id.txt_services_for, capitalize(model.getServices()));
        setText(R.id.txt_location, model.getHh_service_location());

        setText(R.id.txt_health_services, formatMultiSelect(model.getHealth_services()));
        setText(R.id.txt_other_health_services, model.getOther_health_services());
        ...
        setText(R.id.txt_hh_level_services, formatMultiSelect(model.getHh_level_services()));
        setText(R.id.txt_other_hh_level_services, model.getOther_hh_level_services());
        ...
        setText(R.id.txt_caregiver_mmd, capitalize(model.getCaregiver_mmd()));
