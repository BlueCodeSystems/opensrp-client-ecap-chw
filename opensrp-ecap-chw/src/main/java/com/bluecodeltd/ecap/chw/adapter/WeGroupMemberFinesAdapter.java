...
public class WeGroupMemberFinesAdapter extends RecyclerView.Adapter<WeGroupMemberFinesAdapter.ViewHolder> {
    private final Context context;
    private final List<MemberFineModel> dataSet;

    public WeGroupMemberFinesAdapter(Context context, List<MemberFineModel> dataSet) {
    ...
    @NonNull
    @Override
    public WeGroupMemberFinesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_member_service, parent, false);
        return new WeGroupMemberFinesAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WeGroupMemberFinesAdapter.ViewHolder holder, int position) {
