...
import ecap.smartregister.chw.contract.PncMemberProfileContract;
...
import ecap.smartregister.chw.interactor.ChildProfileInteractor;
import ecap.smartregister.chw.interactor.FamilyProfileInteractor;
import ecap.smartregister.chw.interactor.PncMemberProfileInteractor;
import ecap.smartregister.chw.model.ChildRegisterModel;
import ecap.smartregister.chw.model.FamilyProfileModel;
import ecap.smartregister.chw.model.ReferralTypeModel;
import ecap.smartregister.chw.presenter.PncMemberProfilePresenter;
...
import static ecap.smartregister.chw.util.Constants.EventType;
import static ecap.smartregister.chw.util.Constants.JSON_FORM;
import static ecap.smartregister.chw.util.Constants.ProfileActivityResults;
...
public class PncMemberProfileActivity extends CorePncMemberProfileActivity implements PncMemberProfileContract.View {
    ...
    private CommonPersonObjectClient clientObject() {
        CommonRepository commonRepository = ecap.smartregister.chw.util.Utils.context().commonrepository(ecap.smartregister.chw.util.Utils.metadata().familyMemberRegister.tableName);
