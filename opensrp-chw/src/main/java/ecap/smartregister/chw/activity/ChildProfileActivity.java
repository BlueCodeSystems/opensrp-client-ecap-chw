...
import ecap.smartregister.chw.custom_view.FamilyMemberFloatingMenu;
...
import static ecap.smartregister.chw.util.Constants.MALARIA_REFERRAL_FORM;
...
public class ChildProfileActivity extends CoreChildProfileActivity implements OnRetrieveNotifications, CoreChildProfileContract.Flavor {
    ...
    private void openFamilyDueTab() {
        ...
        intent.putExtra(ecap.smartregister.chw.util.Constants.INTENT_KEY.SERVICE_DUE, true);
        startActivity(intent);
    }
