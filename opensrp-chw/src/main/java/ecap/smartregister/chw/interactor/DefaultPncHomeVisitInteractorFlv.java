...
import ecap.smartregister.chw.actionhelper.DangerSignsAction;
import ecap.smartregister.chw.actionhelper.ExclusiveBreastFeedingAction;
import ecap.smartregister.chw.actionhelper.ImmunizationActionHelper;
import ecap.smartregister.chw.actionhelper.ObservationAction;
...
import ecap.smartregister.chw.domain.PncBaby;
...
public abstract class DefaultPncHomeVisitInteractorFlv implements PncHomeVisitInteractor.Flavor {
    ...
    public JSONObject getFormJson(String name, String baseEntityID) throws Exception {
        return ecap.smartregister.chw.util.JsonFormUtils.getJson(view.getContext(), name, baseEntityID);
    }
    ...
    private class VaccineCardHelper extends HomeVisitActionHelper {
        ...
        public void onPayloadReceived(String jsonPayload) {
            try {
                ...
                vaccine_card = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "vaccine_card");
    ...
    private class UmbilicalCordHelper extends HomeVisitActionHelper {
        ...
        public void onPayloadReceived(String jsonPayload) {
            try {
                JSONObject jsonObject = new JSONObject(jsonPayload);
                cord_care = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "cord_care");
            } catch (JSONException e) {
                Timber.e(e);
            }
        }
    ...
    private class PNCHealthFacilityVisitHelper implements BaseAncHomeVisitAction.AncHomeVisitActionHelper {
        ...
        public void onPayloadReceived(String jsonPayload) {
            try {
                ...
                baby_weight = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "baby_weight");
                baby_temp = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "baby_temp");
    ...
    private class KangarooHelper extends HomeVisitActionHelper {
        ...
        public void onPayloadReceived(String jsonPayload) {
            try {
                JSONObject jsonObject = new JSONObject(jsonPayload);
                kangaroo = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "kangaroo");
            } catch (JSONException e) {
                Timber.e(e);
            }
        }
