package ecap.smartregister.chw.actionhelper;
...
public class HealthFacilityVisitAction implements BaseAncHomeVisitAction.AncHomeVisitActionHelper {
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            JSONObject jsonObject = new JSONObject(jsonPayload);
            anc_hf_visit = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "anc_hf_visit");
            anc_hf_visit_date = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "anc_hf_visit_date");
            weight = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "weight");
            sys_bp = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "sys_bp");
            dia_bp = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "dia_bp");
            hb_level = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "hb_level");
            ifa_received = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "ifa_received");
            tests_done = ecap.smartregister.chw.util.JsonFormUtils.getCheckBoxValue(jsonObject, "tests_done");
    ...
    public String postProcess(String s) {
        try {
            ...
            String value = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "anc_hf_visit");
