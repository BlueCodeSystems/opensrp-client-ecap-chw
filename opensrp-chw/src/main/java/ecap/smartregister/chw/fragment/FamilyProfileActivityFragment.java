...
import ecap.smartregister.chw.domain.FormDetails;
import ecap.smartregister.chw.model.FamilyProfileActivityModel;
import ecap.smartregister.chw.presenter.FamilyProfileActivityPresenter;
import ecap.smartregister.chw.provider.FamilyActivityRegisterProvider;
...
public class FamilyProfileActivityFragment extends BaseFamilyProfileActivityFragment {
    ...
    private void displayWashCheckHistory(CommonPersonObjectClient commonPersonObjectClient) {
        ...
        if (CoreConstants.EventType.WASH_CHECK.equalsIgnoreCase(type)) {
            ...
            formDetails.setEventType(ecap.smartregister.chw.util.Constants.EventType.ROUTINE_HOUSEHOLD_VISIT);
            formDetails.setFormName(ecap.smartregister.chw.util.Constants.JSON_FORM.getRoutineHouseholdVisit());
