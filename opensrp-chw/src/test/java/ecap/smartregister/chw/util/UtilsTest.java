...
import ecap.smartregister.chw.BaseUnitTest;
...
import static ecap.smartregister.chw.util.Utils.formatDateForVisual;
import static ecap.smartregister.chw.util.Utils.getClientName;
import static ecap.smartregister.chw.util.Utils.getFormattedDateFromTimeStamp;
...
public class UtilsTest extends BaseUnitTest {
    ...
    public void testGetWFHZScore() {
        double score = ecap.smartregister.chw.util.Utils.getWFHZScore("Male", "70", "70");
        Assert.assertNotEquals(100.0, score, 0.0);
    }

    @Test
    public void testToCSV() {
        String csv = ecap.smartregister.chw.util.Utils.toCSV(Arrays.asList("foo", "bar", "baz"));
