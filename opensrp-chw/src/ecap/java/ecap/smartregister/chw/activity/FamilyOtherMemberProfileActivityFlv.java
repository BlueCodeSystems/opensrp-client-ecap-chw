            ...
            switch (viewId) {
                ...
                case R.id.refer_to_facility_layout:
                    if (BuildConfig.USE_UNIFIED_REFERRAL_APPROACH) {
                        ecap.smartregister.chw.util.Utils.launchClientReferralActivity(activity,  ecap.smartregister.chw.util.Utils.getCommonReferralTypes(activity), baseEntityId);
                    } else {
