...
import ecap.smartregister.chw.actionhelper.ImmunizationActionHelper;
...
import ecap.smartregister.chw.dao.ChwPNCDao;
import ecap.smartregister.chw.dao.ChwPNCDaoFlv;
import ecap.smartregister.chw.dao.PersonDao;
import ecap.smartregister.chw.domain.PNCHealthFacilityVisitSummary;
import ecap.smartregister.chw.util.Constants;
import ecap.smartregister.chw.util.PNCVisitUtil;
...
public class PncHomeVisitInteractorFlv extends DefaultPncHomeVisitInteractorFlv {
        ...
        HomeVisitActionHelper pncDangerSignsMotherHelper = new HomeVisitActionHelper() {
            ...
            public void onPayloadReceived(String s) {
                try {
                    ...
                    danger_signs_present_mama = ecap.smartregister.chw.util.JsonFormUtils.getCheckBoxValue(jsonObject, "danger_signs_present_mama");
    ...
    private void evaluateDangerSignsBaby(Person baby) throws Exception {
        class PNCDangerSignsBabyHelper extends HomeVisitActionHelper {
            ...
            public void onPayloadReceived(String s) {
                try {
                    JSONObject jsonObject = new JSONObject(s);
                    danger_signs_present_child = ecap.smartregister.chw.util.JsonFormUtils.getCheckBoxValue(jsonObject, "danger_signs_present_child");
                } catch (JSONException e) {
                    Timber.e(e);
                }
            }
        ...
        HomeVisitActionHelper helper = new HomeVisitActionHelper() {
            ...
            public void onPayloadReceived(String jsonPayload) {
                try {
                    ...
                    fp_counseling = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "fp_counseling");
                    fp_method = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "fp_method");
                    fp_start_date = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "fp_start_date");
                    fp_period_received = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "fp_period_received");
    ...
    private void evaluateExclusiveBreastFeeding(Person baby) throws Exception {
        class ExclusiveBreastFeedingHelper extends HomeVisitActionHelper {
            ...
            public void onPayloadReceived(String jsonPayload) {
                try {
                    JSONObject jsonObject = new JSONObject(jsonPayload);
                    exclusive_breast_feeding = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "exclusive_breast_feeding");
                } catch (JSONException e) {
                    Timber.e(e);
                }
            }
    ...
    private void evaluateCounselling() throws Exception {
        HomeVisitActionHelper counsellingHelper = new HomeVisitActionHelper() {
            ...
            public void onPayloadReceived(String jsonPayload) {
                try {
                    JSONObject jsonObject = new JSONObject(jsonPayload);
                    couselling_pnc = ecap.smartregister.chw.util.JsonFormUtils.getCheckBoxValue(jsonObject, "couselling_pnc");
                } catch (JSONException e) {
                    Timber.e(e);
                }
            }
    ...
    private void evaluateNutritionStatusMother() throws Exception {
        HomeVisitActionHelper nutritionStatusMotherHelper = new HomeVisitActionHelper() {
            ...
            public void onPayloadReceived(String jsonPayload) {
                try {
                    JSONObject jsonObject = new JSONObject(jsonPayload);
                    nutrition_status_mama = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "nutrition_status_mama");
                } catch (JSONException e) {
                    Timber.e(e);
                }
            }
    ...
    private void evaluateNutritionStatusBaby(Person baby) throws Exception {
        ...
        class NutritionStatusBabyHelper extends HomeVisitActionHelper {
            ...
            public void onPayloadReceived(String jsonPayload) {
                try {
                    JSONObject jsonObject = new JSONObject(jsonPayload);
                    nutrition_status_1m = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "nutrition_status_1m");
                } catch (JSONException e) {
                    Timber.e(e);
                }
            }
    ...
    private void evaluateMalariaPrevention() throws Exception {
        HomeVisitActionHelper malariaPreventionHelper = new HomeVisitActionHelper() {
            ...
            public void onPayloadReceived(String jsonPayload) {
                try {
                    JSONObject jsonObject = new JSONObject(jsonPayload);
                    fam_llin = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "fam_llin");
                    llin_2days = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "llin_2days");
                    llin_condition = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "llin_condition");
                } catch (JSONException e) {
                    Timber.e(e);
                }
            }
    ...
    private void evaluateObsIllnessMother() throws Exception {
        HomeVisitActionHelper obsIllnessMotherHelper = new HomeVisitActionHelper() {
            ...
            public void onPayloadReceived(String jsonPayload) {
                try {
                    JSONObject jsonObject = new JSONObject(jsonPayload);
                    date_of_illness = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "date_of_illness_mama");
                    illness_description = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "illness_description_mama");
                    action_taken = ecap.smartregister.chw.util.JsonFormUtils.getCheckBoxValue(jsonObject, "action_taken_mama");
    ...
    private void evaluateObsIllnessBaby(Person baby) throws Exception {
        class ObsIllnessBabyHelper extends HomeVisitActionHelper {
            ...
            public void onPayloadReceived(String jsonPayload) {
                try {
                    JSONObject jsonObject = new JSONObject(jsonPayload);
                    date_of_illness = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "date_of_illness_child");
                    illness_description = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "illness_description_child");
                    action_taken = ecap.smartregister.chw.util.JsonFormUtils.getCheckBoxValue(jsonObject, "action_taken_child");
                    illnessDate = DateTimeFormat.forPattern("dd-MM-yyyy").parseLocalDate(date_of_illness);
                } catch (Exception e) {
                    Timber.e(e);
                }
    ...
    private class PNCHealthFacilityVisitHelper implements BaseAncHomeVisitAction.AncHomeVisitActionHelper {
        ...
        public void onPayloadReceived(String jsonPayload) {
            try {
                JSONObject jsonObject = new JSONObject(jsonPayload);
                pnc_visit = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, MessageFormat.format("pnc_visit_{0}", visit_num));
                pnc_hf_visit_date = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, MessageFormat.format("pnc_hf_visit{0}_date", visit_num));

                if (visit_num == 1) {
                    vit_a_mother = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "vit_a_mother");
                    ifa_mother = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, "ifa_mother");
                }
        ...
        public String postProcess(String s) {
            try {
                ...
                String value = ecap.smartregister.chw.util.JsonFormUtils.getValue(jsonObject, MessageFormat.format("pnc_visit_{0}", visit_num));
