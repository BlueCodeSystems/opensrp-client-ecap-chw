...
public abstract class CorePncMemberProfileActivity extends BasePncMemberProfileActivity implements CorePncMemberProfileContract.View {
    ...
    public void setFamilyStatus(AlertStatus status) {
        ...
        if (status == AlertStatus.complete) {
            ...
            tvFamilyStatus.setText(getString(org.smartregister.pnc.R.string.family_has_nothing_due));
        } else if (status == AlertStatus.normal) {
            hasDueServices = true;
            tvFamilyStatus.setText(org.smartregister.pnc.R.string.family_has_services_due);
        } else if (status == AlertStatus.urgent) {
            hasDueServices = true;
            tvFamilyStatus.setText(NCUtils.fromHtml(getString(org.smartregister.pnc.R.string.family_has_service_overdue)));
        }
    }
