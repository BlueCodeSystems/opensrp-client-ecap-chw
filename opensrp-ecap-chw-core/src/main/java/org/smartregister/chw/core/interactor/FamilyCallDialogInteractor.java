    ...
    private FamilyCallDialogModel prepareModel(Context context, String familyHeadID,
        ...
        if (personObject != null) {
            ...
            model.setRole((primaryCaregiverID.toLowerCase().equals(familyHeadID.toLowerCase()))
                    ? String.format("%s, %s", context.getString(org.smartregister.pnc.R.string.head_of_family), context.getString(R.string.care_giver))
                    : (isHead ? context.getString(org.smartregister.pnc.R.string.head_of_family)
