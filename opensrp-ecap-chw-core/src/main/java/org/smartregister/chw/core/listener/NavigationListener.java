        ...
        if (v.getTag() instanceof String) {
            ...
            switch (tag) {
                ...
                case CoreConstants.DrawerMenu.REPORTS:
                    ...
                    break;
                case CoreConstants.DrawerMenu.REPORT_REGISTER:
                    startRegisterActivity(getActivity(CoreConstants.REGISTERED_ACTIVITIES.REPORT_REGISTER_ACTIVITY));
                    break;
...
//                    startRegisterActivity(getActivity(CoreConstants.REGISTERED_ACTIVITIES.REFERRALS_REGISTER_ACTIVITY));
                ...
                case CoreConstants.DrawerMenu.UPDATES:
                    ...
                    break;
                case CoreConstants.DrawerMenu.FLAGS:
                    startRegisterActivity(getActivity(CoreConstants.REGISTERED_ACTIVITIES.FLAGS_ACTIVITY));
                    break;
                default:
